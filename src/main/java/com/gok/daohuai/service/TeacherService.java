...
//                teacher.getPassword().equals(sqlSession.getMapper(TeacherMapper.class).getPasswordById(Integer.valueOf(teacher.getTeacherId())))) {
...
//        }
    public void login(Teacher teacher) {
        sqlSession.getMapper(TeacherMapper.class).getTeacherById(Integer.valueOf(teacher.getTeacherId()));
        if (teacher.getPassword().equals(sqlSession.getMapper(TeacherMapper.class).getPasswordById(Integer.valueOf(teacher.getTeacherId())))) {
            System.out.println("登录成功");
        } else {
            System.out.println("登录失败");
        }
    ...
    public void showClass(Teacher teacher) {
        sqlSession.getMapper(TeacherMapper.class).showYourClass(teacher.getTeacherId());
        System.out.println(sqlSession.getMapper(TeacherMapper.class).showYourClass(teacher.getTeacherId()));

        System.out.println("查看班级成功");
    }
